/*
 * origin source code: https://github.com/sean-lab/ThisIsAlgorithm/blob/main/06/RedBlackTree/RedBlackTree.c
 * This code is a small modification of the original code!!!
 * modify: RBT_CreateNode, RBT_DestoryNode, RBT_SearchNode, RBT_InsertNodeHelper, RBT_RemoveNode
 * */
...
RBTNode* RBT_CreateNode( ElementType NewKey, ElementType NewData )
{
    ...
    NewNode->Key    = (ElementType)malloc(strlen(NewKey) + 1);
...
void RBT_InsertNodeHelper( RBTNode** Tree, RBTNode* NewNode)
{
    ...
    if ( strcmp((*Tree)->Key, NewNode->Key) < 0 ) 
    {
        if ( (*Tree)->Right == Nil )
        {
            (*Tree)->Right  = NewNode;
    ...
    else if ( strcmp((*Tree)->Key, NewNode->Key) > 0 ) 
    {
        if ( (*Tree)->Left == Nil )
        {
            (*Tree)->Left   = NewNode;
